...
if __name__ == "__main__":
    try:
        ...
        try:
            with open(f"/Flux/db/{username}_transfer_progress.obj", mode="rb") as transfer_dump:
        ...
        with open(f"/Flux/db/{username}_transfer_progress.obj", mode="wb") as transfer_dump:
