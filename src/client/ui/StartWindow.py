...
class Ui_StartWindow(QWidget):
    ...
    def retranslateUi(self, MainWindow) -> None:
        MainWindow.setWindowTitle(QCoreApplication.translate("StartWindow", "Welcome To Flux", None))
        self.label.setText(QCoreApplication.translate("StartWindow", "Flux", None))
